...
(autoload 'xmtn-status-one-1 "xmtn-multi-status" "\
Create an xmtn-multi-status buffer from xmtn-propagate.

\(fn ROOT NAME HEAD-REV STATUS-BUFFER HEADS LOCAL-CHANGES)" nil nil)

;;;***

;;;### (autoloads (xmtn-propagate-one xmtn-propagate-multiple) "xmtn-propagate"
;;;;;;  "xmtn-propagate.el" (19597 31514))
...
;;;;;;  xmtn-review-update xmtn-dvc-missing xmtn-dvc-changelog xmtn-log
;;;;;;  xmtn-dvc-log xmtn-revision-list-entry-patch-printer xmtn-revision-refresh-maybe)
;;;;;;  "xmtn-revlist" "xmtn-revlist.el" (19597 31514))
...
(autoload 'xmtn-review-update "xmtn-revlist" "\
...
;;;***

;;;### (autoloads (xmtn-sync-sync) "xmtn-sync" "xmtn-sync.el" (19597
;;;;;;  31514))
;;; Generated autoloads from xmtn-sync.el

(autoload 'xmtn-sync-sync "xmtn-sync" "\
...
\(fn LOCAL-DB REMOTE-HOST REMOTE-DB)" t nil)
...
;;;;;;  "xmtn-run.el") (19643 40957 382436))
